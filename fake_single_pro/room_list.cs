...
namespace fake_single
{
    public partial class room_list : Form
    {
        ...
        private void room_list_Load(object sender, EventArgs e)
        {
            ...
            this.is_reserved.Items.Add("不限");
            this.is_reserved.Items.Add("不保留");
            this.is_reserved.Items.Add("保留");
        ...
        public void load_list_view()
        {
            ...
            room_list_view.Columns.Add("保留", 100, HorizontalAlignment.Center);
        ...
        private List<RoomBean> getQueryResult()
        {
            ...
            String is_reserved_text = is_reserved.SelectedItem.ToString();
            if (!is_reserved_text.Equals("不限"))
            {
                if (is_reserved_text.Equals("保留"))
                {
                    reserved = 1;
                }
                else
            ...
            Helper helper = Helper.getInstance();
            return helper.find(min_range, max_range, reserved, token, building_num, 0);
        }
        ...
        private void load_list_view_data(int page_num)
        {
            ...
            for(int i = begain_num; i < begain_num + PAGE_SIZE && result_size > 0; i++)
            {
                ...
                String reserved = room.getIsReserved() == 0 ? "否" : "是";
